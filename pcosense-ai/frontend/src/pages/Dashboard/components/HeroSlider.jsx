...
const SLIDES = [
  {
    ...
    subtitle: 'Detect PCOS early using AI-powered health screening and understand your body better.',
  ...
  },
  {
    ...
    subtitle: 'Understand symptoms, causes, treatments, and lifestyle strategies for managing PCOS effectively.',
    cta: 'Read Articles',
    ctaRoute: ROUTES.DASHBOARD,
